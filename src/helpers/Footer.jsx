      ...
      <div className="container">
        <div className="sm:flex-wrap md:flex sm:space-y-4 md:space-y-0 text-white">
          <div className="flex-column justify-between w-1/5 sm:hidden lg:flex">
            ...
            <div className="opacity-60 text-sm">2022. Smart Mining <br/> All rights reserved</div>
          </div>
          <div className="sm:w-full md:w-1/3 lg:w-1/5 space-y-3">
            ...
            <ul className="opacity-60 space-y-2">
              <li>
                <a onClick={smoothScroll} href="#team" data-href="#team">Our Team</a>
              </li>
              <li>
                <a onClick={smoothScroll} href="#calculator" data-href="#calculator">Calculator</a>
              </li>
              <li>
          ...
          <div className="sm:w-full md:w-1/3 lg:w-1/5 space-y-3">
            ...
            <ul className="opacity-60 space-y-2">
              ...
              <li>
                <a href="/certificates/Certificate.pdf" target="_blank">Certificate</a>
              </li>
            </ul>
          </div>
          <div className="sm:w-full md:w-1/3 lg:w-1/5 space-y-3">
          ...
          <div className="w-1/5 text-right sm:hidden lg:block">
            <div className="inline-block">
              <a href="/referral" className="btn-border">
        ...
        <div className="text-white opacity-40 sm:pt-6 lg:pt-10 text-sm">
          <div className="lg:hidden text-sm">2022. Smart Mining <br/> All rights reserved</div>
          <div className="sm:w-full lg:w-4/5 sm:pt-6 lg:pt-0"> Smart Mining involves financial risks and may not be
            appropriate for all people. The information presented here is for information and educational purposes only
            and should not be considered an offer or solicitation to invest to Smart Mining or elsewhere. Any investment
            decisions that you make are solely your responsibility. <br/>Smart Mining does not provide service for USA
              residents.</div>
        </div>
      </div>
    </footer>
