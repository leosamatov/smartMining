...
function TopBar({
  ...
  return (
    <div className={`top ${isLight ? "main text-gray-700" : "main-dark-bg text-white"}`}
      style={isTransparent ? {background: "transparent"} : {}}>
      {!isLight && <img src="img/Ellipse-header.svg" className="absolute top-0 left-0"/>}
          ...
          <div className="header h-24 flex space-x-4 items-center relative">
            <div>
              <a href="/" className="flex items-center">
                ...
                <div>
                  <img src={isLight ? "img/TRON_b.svg" : "img/TRON.svg"} alt=""/>
                </div>
              </a>
            </div>
            <div className="flex-grow text-center">
              <nav id="main_menu"
                ...
                <ul className="sm:flex-grow lg:flex sm:space-y-5 lg:space-y-0 lg:space-x-10 text-lg">
                  ...
                  <li>
                    <a href="#calculator" data-href="#calculator" onClick={smoothScroll}>Calculator</a>
                  </li>
                  <li>
                    <a href="#contracts" data-href="#contracts" onClick={smoothScroll}>Сontracts</a>
                  </li>
                  <li>
                ...
                <div className="md:hidden inline-block mt-20">
                  <div className="auth">
                    <a href="" onClick={connectWallet}
                       className={`btn-border ${isLight ? "bg-gray-100 border-gray-400 hover:text-gray-900" : ""}`}>
            ...
            <div className="flex space-x-4 items-center">
              ...
              <div onClick={onMenuToggle}>
                <a href="" style={{display: !showMenu ? "block" : "none"}}
          ...
          <div className="container relative">
            <div className="slider flex-wrap lg:flex pt-10 lg:pt-24 pb-48 sm:-mb-48 lg:mb-0">
              <div className="w-full sm:text-center lg:text-left lg:w-1/3 sm:space-y-3 md:space-y-5 space-y-7">
                <div className="sm:text-5xl md:text-7xl lg:text-8xl title-font">SMART CLOUD MINING PLATFORM</div>
                <div className="md:px-20 lg:px-0 text-lg"> The largest mining company in Australia, bringing its
                  customers
                  from 168% per annum. You rent miners - we choose the most profitable mining areas!
                </div>
                <div className="pt-4">
              ...
              <div
                className="h-100 lg:-mt-20 sm:max-h-96 lg:max-h-1 lg:text-right sm:text-center w-full lg:w-2/3 lg:pl-40 lg:pr-0 sm:px-20">
                <lottie-player className="inline-block w-full h-auto" src="/img/animation/lf30_9p8jufyr.json"
                  background="transparent" speed="1" loop autoplay/>
              </div>
            </div>
            <img src="img/Coins.png" className="-bottom-20 -left-48 absolute"/>
          </div>
        )
        }
