...
const MINING_STEPS_DATA = [
  {
    title: "Sign up now",
    description: "Fill out the form and be ready to start cloud mining in less than a minute",
    src: "img/Zareg.svg"
  },
  {
    title: "Buy a contract",
    description: "Choose a contract that suits you and start cryptocurrency cloud mining",
    src: "img/Buy.svg"
  },
  {
    title: "Get payouts",
