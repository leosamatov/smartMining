      ...
      <div className="container">
        <div className="sm:flex-wrap lg:flex sm:space-y-20 lg:space-y-0">
          <div className="sm:w-full lg:w-1/2 sm:space-y-4 md:space-y-0 lg:space-y-14 sm:flex-wrap md:flex lg:flex-wrap">
            <div
              className="sm:flex md:flex-wrap lg:flex sm:space-y-4 md:space-y-0 lg:space-x-8 lg:w-full sm:w-full md:w-1/3">
              <div>
            ...
            <div
              ...
              <div className="sm:space-y-2 lg:space-y-5">
                ...
                <div className="text-gray-700">New clients for the last 7 days</div>
              </div>
            </div>
            <div
              className="sm:flex md:flex-wrap lg:flex sm:space-y-4 md:space-y-0 lg:space-x-8 lg:w-full sm:w-full md:w-1/3">
              ...
              <div className="sm:space-y-2 lg:space-y-5">
                ...
                <div className="text-gray-700">Average technical support response time</div>
              </div>
            </div>
          </div>
          <div className="sm:w-full lg:w-1/2 lg:pl-28">
            <div className="relative main-dark-bg rounded-xl">
              ...
              <div
                className="sm:py-10 md:py-14 sm:px-5 md:px-10 lg:px-20 relative text-white sm:space-y-5 md:space-y-10 lg:space-y-14">
                <div className="lg:max-w-min sm:max-w-2/3 title-font md:text-4xl sm:text-3xl"> Start earning now</div>
                <form method="get" action="/register" className="sm:space-y-4 md:space-y-7">
                  <div className="sm:flex-wrap md:flex lg:flex-wrap sm:space-y-4 md:space-y-0 lg:space-y-7 md:space-x-4 lg:space-x-0">
                    <button type="" className="btn-orange sm:w-full md:w-2/5 lg:w-full ">
