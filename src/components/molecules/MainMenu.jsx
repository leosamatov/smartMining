...
function MainMenu({activeItem = "/referral"}) {
  ...
  return (
    <aside id="main_menu" className={
      `bg-white sm:absolute left-0 sm:hidden lg:block top-0 lg:relative z-50 ${open ? "" : "minim px-1 text-center"}`
    }>
      ...
      <div className={`lg:space-y-20 sm:space-y-3 lg:py-5 sm:py-1 pb-5 ${open ? "px-6" : "px-1"}`}>
        ...
        <ul className="space-y-5">
          <li>
            <a href="/user" className={`${activeItem === "/user" ? "bg-gray-800 text-white" : ""} space-x-2 block leading-4 font-medium hover:no-underline px-3 py-2.5 rounded-lg`}>
          ...
          <li>
            <a href="/history" className={`${activeItem === "/history" ? "bg-gray-800 text-white" : ""} space-x-2 block leading-4 font-medium hover:no-underline px-3 py-2.5 rounded-lg`}>
          ...
          <li>
            <a href="/referral"  className={`${activeItem === "/referral" ? "bg-gray-800 text-white" : ""} space-x-2 block leading-4 font-medium hover:no-underline px-3 py-2.5 rounded-lg`}>
